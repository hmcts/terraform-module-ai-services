resource "azurerm_ai_foundry" "ai_foundry" {
  ...
  storage_account_id    = azurerm_storage_account.workspace_storage_account[0].id == null ? var.existing_storage_account_id : azurerm_storage_account.workspace_storage_account[0].id
